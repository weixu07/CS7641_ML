    ...
    for i, algorithm in enumerate(algorithms):
        ...
        for random_seed in random_seeds:
            ...
            for max_iter in kwargs[max_iters[i]]:
                ...
                nn = NeuralNetwork(hidden_nodes=[7, 2], activation='relu',
...
def test_nn_performances(x_train, x_test, y_train, y_test, random_seed, **kwargs):
    ...
    rhc_nn = NeuralNetwork(hidden_nodes=[7, 2], activation='relu',
    ...
    sa_nn = NeuralNetwork(hidden_nodes=[7, 2], activation='relu',
    ...
    ga_nn = NeuralNetwork(hidden_nodes=[7, 2], activation='relu',
